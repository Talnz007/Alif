...
# Gemini API key (replace with environment variable in production)
api_key = "Your API key Goes Here"

# Create analyzer instance
analyzer = PDFAnalyzerGemini(api_key)
...
async def analyze_pdf(file: UploadFile = File(...)):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=str(e))
>>>>>>> c0fc8b3 (Restructured the app's directory layout and modularized core components for better maintainability and readability.)
